...
@Log4j2
public class MLOpenSearchRerankProcessorCloudNativeIT extends BaseNeuralSearchCloudNativeIT {
    private final static String PIPELINE_NAME = "rerank-mlos-pipeline-" + RandomStringUtils.randomAlphabetic(5).toLowerCase();
    private final static String INDEX_NAME = "rerank-test-" + RandomStringUtils.randomAlphabetic(5).toLowerCase();
    ...
    public void testCrossEncoderRerankProcessor() {
        // String modelId = "46803f57-f27a-4526-a8b5-2bcb226bbf96";
        System.out.println("PIPELINE_NAME is");
        System.out.println(PIPELINE_NAME);
        System.out.println("INDEX_NAME is");
        System.out.println(INDEX_NAME);
        try {
            createSearchPipelineViaConfig(MODEL_ID, PIPELINE_NAME, "processor/RerankMLOpenSearchPipelineConfiguration.json");
            setupIndex();
            Thread.sleep(30 * 1000);
            runQueries();
        } catch (Exception e) {
            log.error("Exception is caught for testCrossEncoderRerankProcessor", e);
            throw e;
        } finally {
    ...
    private void runQueries() throws Exception {
        ...
        System.out.println("response1.get(\"hits\")");
        System.out.println(response1.get("hits"));
