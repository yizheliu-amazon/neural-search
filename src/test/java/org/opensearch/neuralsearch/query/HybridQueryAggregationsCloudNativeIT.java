...
public class HybridQueryAggregationsCloudNativeIT extends BaseNeuralSearchCloudNativeIT {
    ...
    public void testPostFilterOnIndexWithMultipleShards_WhenConcurrentSearchNotEnabled_thenSuccessful() {
        ...
        System.out.println("Deleting multiple shards index");
        deleteIndex(TEST_MULTI_DOC_INDEX_WITH_TEXT_AND_INT_MULTIPLE_SHARDS);
        System.out.println("Sleep 60 seconds after deleting index");
    ...
    public void testPostFilterOnIndexWithSingleShards_WhenConcurrentSearchNotEnabled_thenSuccessful() {
        ...
        // System.out.println("Deleting single shard index");
        // deleteIndex(TEST_MULTI_DOC_INDEX_WITH_TEXT_AND_INT_SINGLE_SHARD);
        System.out.println("========================= Sleep 60 seconds. Please manually delete index =========================");
        Thread.sleep(60 * 1000);
    ...
    private void initializeIndexIfNotExist(String indexName) throws IOException {
        if (TEST_MULTI_DOC_INDEX_WITH_TEXT_AND_INT_MULTIPLE_SHARDS.equals(indexName)
            ...
            System.out.println("Sleep 180 seconds after indexing docs");
