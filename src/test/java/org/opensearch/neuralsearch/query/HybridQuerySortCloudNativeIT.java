...
public class HybridQuerySortCloudNativeIT extends BaseNeuralSearchCloudNativeIT {
    ...
    public static void setUpCluster() {
        ...
        HybridQuerySortCloudNativeIT instance = new HybridQuerySortCloudNativeIT();
        instance.initClient();
    }
    ...
    private void initializeIndexIfNotExists(String indexName, int numShards) {
        if (!indexExists(indexName)) {
            ...
            System.out.println("Sleeping 10 secs after ingestion");
